        ...
        <div className="container">
            <div className="row ">
                <div className="col-lg-12 mt-5">
                    <h1 className="text-center mt-60 mb-40">Terms and Conditions</h1>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                ...
                                "Us" or "Our" in this Agreement) refers to Chortoq Hospitality, 7,
                                Namunaviy street, Muchum SHFY Sohibkor MFY, Chartak area, Namangan
                                district, Uzbekistan.
                            </p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p>
                                <strong>Website</strong> refers to Chortoq Hospitality, accessible from{" "}
                                <a
                                    href="https://chortoqgrandresort.com"
                                    rel="external nofollow noopener"
                                    target="_blank"
                                >
                                    https://chortoqgrandresort.com
                                </a>
                            </p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By email: CESC@grandchortoqresort.com</li>
                    </ul>
                </div>
            </div>
        </div>
